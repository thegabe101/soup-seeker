...
app.post('/register', (req, res) => {
    ...
    db.query("CREATE TABLE users (email VARCHAR(20) NOT NULL, username VARCHAR(20) NOT NULL, password VARCHAR(20) NOT NULL); INSERT IGNORE INTO users (email, username, password) VALUES (?, ?, ?);", [email, username, password], (err, result) => {
        console.log(result)
        console.log(err);
    })
});
